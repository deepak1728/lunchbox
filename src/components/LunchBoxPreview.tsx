...
// ✅ Use import.meta.env.BASE_URL for relative images
const baseUrl = import.meta.env.BASE_URL;

const defaultImages: Record<Slot, string> = {
  rice: "",
  curry: `${baseUrl}images/veg-curry.png`,
  dal: `${baseUrl}images/dal.png`,
  fruits: `${baseUrl}images/fruits.png`,
  dessert: `${baseUrl}images/dessert.png`,
};
